...
public class GuildAttributionDefinitionsControllerTests
{
    ...
    {
        var result = await MakeSut(null).GetDefinitions("guild-1", 5, null, default);
    ...
    public async Task GetDefinitions_QuerySucceeds_ReturnsOk()
    {
        ...
        _queries.Setup(q => q.DispatchAsync<GetGuildAttributionDefinitionsQuery, List<GuildAttributionDefinitionResponse>>(
                It.Is<GetGuildAttributionDefinitionsQuery>(qr => qr.GuildId == "guild-1" && qr.GuildBranchId == 5 && qr.RequesterDiscordId == "user-1"), default))
            .ReturnsAsync(Result<List<GuildAttributionDefinitionResponse>>.Ok(response));

        var result = await MakeSut().GetDefinitions("guild-1", 5, null, default);
    ...
    public async Task CreateDefinition_NoDiscordId_ReturnsUnauthorized()
    {
        ...
        var result = await MakeSut(null).CreateDefinition("guild-1", 5, command, default);
    ...
    public async Task CreateDefinition_SetsGuildIdAndRequesterFromRouteAndClaim()
    {
        ...
        var result = await MakeSut("user-1").CreateDefinition("guild-1", 5, command, default);

        result.Should().BeOfType<OkObjectResult>();
        dispatched.Should().NotBeNull();
        dispatched!.GuildId.Should().Be("guild-1");
        dispatched.GuildBranchId.Should().Be(5);
    ...
    public async Task CreateDefinition_CommandFails_ReturnsBadRequest()
    {
        ...
        var result = await MakeSut().CreateDefinition("guild-1", 5, command, default);
    ...
    public async Task UpdateDefinition_NoDiscordId_ReturnsUnauthorized()
    {
        ...
        var result = await MakeSut(null).UpdateDefinition("guild-1", 5, 7, command, default);
    ...
    public async Task UpdateDefinition_SetsGuildIdRequesterAndDefinitionIdFromRoute()
    {
        ...
        var result = await MakeSut("user-1").UpdateDefinition("guild-1", 5, 7, command, default);
    ...
    public async Task UpdateDefinition_CommandFails_ReturnsBadRequest()
    {
        ...
        var result = await MakeSut().UpdateDefinition("guild-1", 5, 7, command, default);
    ...
    {
        var result = await MakeSut(null).DeleteDefinition("guild-1", 5, 7, default);
    ...
    public async Task DeleteDefinition_Succeeds_ReturnsOk()
    {
        ...
        var result = await MakeSut("user-1").DeleteDefinition("guild-1", 5, 7, default);
    ...
    public async Task DeleteDefinition_CommandFails_ReturnsBadRequest()
    {
        ...
        var result = await MakeSut().DeleteDefinition("guild-1", 5, 7, default);
    ...
    public async Task ReorderDefinitions_NoDiscordId_ReturnsUnauthorized()
    {
        ...
        var result = await MakeSut(null).ReorderDefinitions("guild-1", 5, command, default);
    ...
    public async Task ReorderDefinitions_Succeeds_ReturnsOk()
    {
        ...
        var result = await MakeSut("user-1").ReorderDefinitions("guild-1", 5, command, default);
    ...
    public async Task ReorderDefinitions_CommandFails_ReturnsBadRequest()
    {
        ...
        var result = await MakeSut().ReorderDefinitions("guild-1", 5, command, default);
    ...
    public async Task SetSectionIcon_NoDiscordId_ReturnsUnauthorized()
    {
        ...
        var result = await MakeSut(null).SetSectionIcon("guild-1", 5, command, default);
    ...
    public async Task SetSectionIcon_SetsGuildIdAndRequesterFromRouteAndClaim()
    {
        ...
        var result = await MakeSut("user-1").SetSectionIcon("guild-1", 5, command, default);
