...
public class GuildUserAddHandlerTests
{
    ...
    private readonly Mock<ILogger<GuildUserAddHandler>>   _logger       = new();
    private readonly GuildUserAddHandler                  _sut;

    private const ulong UserId  = 511624657162731533UL;
    private const ulong GuildId = 796438478925725796UL;

    public GuildUserAddHandlerTests()
    {
        ...
        _sut = new GuildUserAddHandler(_scopeFactory.Object, _logger.Object);
    }
    ...
    [InlineData(true)]
    [InlineData(false)]
    public async Task HandleAsync_NotifiesTheJoinedUser(bool loggerEnabled)
    {
