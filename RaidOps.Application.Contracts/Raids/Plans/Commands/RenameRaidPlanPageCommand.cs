...
public class RenameRaidPlanPageCommand : ICommandRequest
{
    ...
    /// <summary>The page to rename. Set by the controller from the route, not from the request body.</summary>
