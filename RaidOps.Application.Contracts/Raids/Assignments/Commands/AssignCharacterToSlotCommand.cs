...
/// slot is already occupied (use <see cref="SwapSlotAssignmentsCommand"/> to exchange two occupied
/// slots instead), if the character isn't eligible, or if it conflicts with a declared absence or
/// another event's lockout on a shared zone. The requesting user must hold
