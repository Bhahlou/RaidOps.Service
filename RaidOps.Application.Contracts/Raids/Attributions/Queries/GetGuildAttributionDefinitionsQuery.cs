...
/// <summary>
/// Returns a guild branch's raid-attribution template — every <c>GuildAttributionDefinition</c> row of
/// that branch, ordered by <c>SortOrder</c>. Officer-gated: the template editor is officer-only.
/// </summary>
public class GetGuildAttributionDefinitionsQuery : IQueryRequest<List<GuildAttributionDefinitionResponse>>
{
    ...
    /// <summary>Surrogate ID of the guild branch whose template to return. Set by the controller from the route.</summary>
