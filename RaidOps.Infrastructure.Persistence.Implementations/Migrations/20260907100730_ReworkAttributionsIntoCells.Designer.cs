...
namespace RaidOps.Infrastructure.Persistence.Implementations.Migrations
{
    ...
    [Migration("20260907100730_ReworkAttributionsIntoCells")]
    partial class ReworkAttributionsIntoCells
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RaidOps.Domain.Models.Raids.Attributions.AttributionDefinitionCell", b =>
                {
                    ...
                    b.Property<int?>("RequiredClassId")
                        .HasColumnType("integer");

                    b.Property<int?>("RequiredRole")
                        .HasColumnType("integer");

                    b.Property<int?>("RequiredSpecId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RaidOps.Domain.Models.Raids.Attributions.RaidEventAttribution", b =>
                {
                    ...
                    b.HasKey("RaidEventId", "AttributionDefinitionCellId");
            ...
            modelBuilder.Entity("RaidOps.Domain.Models.Raids.Attributions.AttributionDefinitionCell", b =>
                {
                    ...
                    b.HasOne("RaidOps.Domain.Models.Reference.WowClass", "RequiredClass")
                        .WithMany()
                        .HasForeignKey("RequiredClassId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("RaidOps.Domain.Models.Reference.Spec", "RequiredSpec")
                        .WithMany()
                        .HasForeignKey("RequiredSpecId")
                        .OnDelete(DeleteBehavior.Restrict);
