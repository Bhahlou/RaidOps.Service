...
namespace RaidOps.Infrastructure.Persistence.Implementations.Migrations
{
    ...
    [Migration("20260731085437_AddRaidBuilder")]
    partial class AddRaidBuilder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RaidOps.Domain.Models.Raids.GuildRaidZoneLockout", b =>
                {
                    ...
                    b.Property<DateOnly?>("LockoutAnchorDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("RaidOps.Domain.Models.Raids.RaidZone", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ExpansionId = 2,
                            GroupCount = 2,
                            LockoutAnchorDate = new DateOnly(2007, 1, 16),
                            LockoutCadenceDays = 7,
                            Name = "Karazhan",
                            ShortCode = "Kara",
                            SlotsPerGroup = 5,
                            SortOrder = 1
